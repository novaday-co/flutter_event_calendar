...
class Fa {
  ...
  static Map shortMonthNames = const {
    'fa': {
      CalendarType.JALALI: ['فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبا', 'آذر', 'دی', 'بهم', 'اسف'],
      CalendarType.GREGORIAN: ['ژان', 'قور', 'مار', 'آور', 'مه', 'ژوئ', 'ژوئی', 'اوت', 'سپت', 'اکت', 'نوا', 'دسا'],
    }
  };
  static Map fullDayNames = const {
    'fa': {
      CalendarType.JALALI: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنج شنبه', 'جمعه'],
      CalendarType.GREGORIAN: ['یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه', 'شنبه'],
    }
  };
